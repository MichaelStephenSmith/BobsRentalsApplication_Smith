...
# PROJECT SUMMARY
This project implements a complete console based Python application for Bobs Ski & Snowboard Rentals. The goal was to build a fully functional
rental system using a class library created by another programmer. The application manages starting inventory, processes new rentals, handles returns,
